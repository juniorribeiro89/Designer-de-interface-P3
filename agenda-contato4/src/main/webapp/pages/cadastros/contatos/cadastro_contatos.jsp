          ...
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" method="post" action="${pageContext.request.contextPath}/contatoControllerServlet">
                ...
                <div align="center">
                    <input type="${opcao.equals('visualizar') ? 'hidden' : 'submit' }" class="btn btn-outline-success" value="Salvar">
                    <a href="${pageContext.request.contextPath}/contatoControllerServlet" class="btn btn-outline-primary">Voltar</a>
                </div>
              </form>
            </div>
          </div>
